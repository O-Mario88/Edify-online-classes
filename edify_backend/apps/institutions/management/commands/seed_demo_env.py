...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            # Finance layer removed — institution fee / ERP module was scoped
            # out of the product. If it comes back, restore `seeders/finance_factory.py`
            # and the `all | finance` branch here.
