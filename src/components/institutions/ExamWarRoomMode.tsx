    ...
    <div className="space-y-6">
       ...
       <div className="bg-red-50 border border-red-200 rounded-lg p-4 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-3">
             <div className="w-12 h-12 bg-red-100 text-red-600 rounded-full flex items-center justify-center animate-pulse shrink-0">
       ...
       <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
         <Card className="border-slate-200 shadow-sm border-l-4 border-l-red-500">
            <CardContent className="p-4 flex flex-col">
               <span className="text-sm font-bold text-slate-500 flex items-center gap-2 mb-2"><DollarSign className="w-4 h-4 text-slate-400"/> Unpaid Candidates</span>
               <span className="text-3xl font-black text-slate-800">42</span>
               <span className="text-xs text-red-500 mt-1 font-medium">Clearance required for seating</span>
            </CardContent>
         </Card>
         <Card className="border-slate-200 shadow-sm border-l-4 border-l-orange-500">
            <CardContent className="p-4 flex flex-col">
               <span className="text-sm font-bold text-slate-500 flex items-center gap-2 mb-2"><Clock className="w-4 h-4 text-slate-400"/> Chronic Absenteeism</span>
               <span className="text-3xl font-black text-slate-800">14<span className="text-lg text-slate-400 font-bold ml-1">students</span></span>
         ...
         <Card className="border-slate-200 shadow-sm border-l-4 border-l-yellow-500">
            <CardContent className="p-4 flex flex-col">
               <span className="text-sm font-bold text-slate-500 flex items-center gap-2 mb-2"><BookOpen className="w-4 h-4 text-slate-400"/> Missing Assignments</span>
               <span className="text-3xl font-black text-slate-800">89</span>
               <span className="text-xs text-yellow-600 mt-1 font-medium">Across 3 core subjects</span>
            </CardContent>
         </Card>
         <Card className="border-slate-200 shadow-sm border-l-4 border-l-indigo-500">
            <CardContent className="p-4 flex flex-col">
               <span className="text-sm font-bold text-slate-500 flex items-center gap-2 mb-2"><Users className="w-4 h-4 text-slate-400"/> Priority Revision Grps</span>
               <span className="text-3xl font-black text-slate-800">5</span>
               <span className="text-xs text-indigo-600 mt-1 font-medium">Auto-generated via diagnostics</span>
            </CardContent>
         </Card>
       </div>
       ...
       <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card className="shadow-sm">
             <CardHeader className="pb-3 border-b border-slate-100 bg-slate-50/50">
               <CardTitle className="text-md flex items-center gap-2 text-slate-800"><Target className="w-4 h-4 text-indigo-600" /> Overall Readiness by Subject</CardTitle>
             </CardHeader>
                ...
                {[
                  ...
                  <div key={i}>
                    <div className="flex justify-between text-sm font-medium mb-1.5">
                       ...
                       <span className={`${s.readiness < 60 ? 'text-red-500' : 'text-green-600'} font-bold`}>{s.readiness}%</span>
                    </div>
          ...
          <Card className="shadow-sm border-red-200 border">
             <CardHeader className="pb-3 border-b border-red-100 bg-red-50/50">
               <CardTitle className="text-md flex items-center gap-2 text-red-900"><AlertCircle className="w-4 h-4 text-red-600" /> Platform Identified Weak Topics</CardTitle>
             </CardHeader>
                  ...
                  {[
                    ...
                    <div key={i} className="p-3 px-4 flex items-center justify-between hover:bg-red-50/30 transition-colors">
                       <div>
                          ...
                          <p className="text-xs text-slate-500">{w.subject} • {w.group}</p>
                       </div>
