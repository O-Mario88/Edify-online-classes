       ...
       <CardContent className="p-4 space-y-5">
          <div className="grid grid-cols-2 gap-4">
             ...
             <div>
                <div className="flex justify-between text-xs font-bold text-slate-500 mb-1">
                   <span>Turaround</span>
                   <span className={metrics.markingTurnaroundDays > 5 ? 'text-red-500' : ''}>{metrics.markingTurnaroundDays} days</span>
                </div>
          ...
          <div className="bg-indigo-50/50 p-3 rounded-lg border border-indigo-100 flex items-start gap-3">
             ...
             <div>
                <p className="text-xs font-bold uppercase text-indigo-500 tracking-wider mb-0.5">Focus Goal</p>
