    ...
    <Card className="h-full flex flex-col shadow-sm border-slate-200">
      <CardHeader className="bg-slate-50/50 border-b border-slate-100 pb-3">
         <CardTitle className="text-lg font-bold text-slate-800 flex items-center gap-2">
            <Library className="w-5 h-5 text-blue-800" />
            Content Statistics
      ...
      <CardContent className="p-5 flex-1 flex flex-col justify-between">
        <div className="grid grid-cols-3 gap-4 mb-6">
          <div className="bg-white border text-center border-slate-100 rounded-xl p-4 shadow-sm hover:border-slate-200 transition-colors">
             <Video className="w-5 h-5 text-indigo-700 mx-auto mb-2" />
             <div className="text-2xl font-black text-slate-800">42</div>
             <div className="text-[10px] font-bold text-slate-700 uppercase tracking-widest mt-1">Videos</div>
          </div>
          <div className="bg-white border text-center border-slate-100 rounded-xl p-4 shadow-sm hover:border-slate-200 transition-colors">
             <Book className="w-5 h-5 text-emerald-500 mx-auto mb-2" />
             <div className="text-2xl font-black text-slate-800">18</div>
             <div className="text-[10px] font-bold text-slate-700 uppercase tracking-widest mt-1">Notes</div>
          </div>
          <div className="bg-white border text-center border-slate-100 rounded-xl p-4 shadow-sm hover:border-slate-200 transition-colors">
             <Library className="w-5 h-5 text-amber-700 mx-auto mb-2" />
             <div className="text-2xl font-black text-slate-800">3</div>
             <div className="text-[10px] font-bold text-slate-700 uppercase tracking-widest mt-1">Books</div>
          </div>
        </div>
        ...
        <div className="bg-blue-50/50 rounded-xl p-5 border border-blue-100 mb-4 flex-1 flex flex-col justify-center shadow-inner">
           ...
           <p className="text-sm text-slate-800 leading-relaxed font-medium mb-3">
             Active students accessing your materials across 45 institutions on Maple.
           </p>
