    ...
    <Card className="h-full flex flex-col justify-between shadow-sm border-purple-100 bg-gradient-to-br from-white to-purple-50/30">
      <CardHeader className="pb-3 border-b border-purple-50">
        <div className="flex justify-between items-center">
          ...
          {reflectionPhase === 'completed' && <CheckCircle className="w-5 h-5 text-emerald-700" />}
        </div>
      </CardHeader>
      <CardContent className="pt-4 flex-1 flex flex-col justify-between">
        {reflectionPhase === 'prompt' && (
          <div className="space-y-4">
            ...
            <div className="bg-white p-3 rounded-lg border border-purple-100 text-sm italic text-slate-800 mb-2">
        ...
        {reflectionPhase === 'input' && (
          <div className="space-y-3">
            <div className="flex gap-2 text-sm text-slate-700 mb-2 font-medium">
              <Lightbulb className="w-4 h-4 text-amber-700" /> What worked well? Who struggled?
            </div>
            <textarea
        ...
        {reflectionPhase === 'completed' && (
          <div className="text-center py-4 space-y-3">
            ...
            <p className="text-sm text-slate-800">Your insights have been securely saved to your Teacher Growth Passport.</p>
