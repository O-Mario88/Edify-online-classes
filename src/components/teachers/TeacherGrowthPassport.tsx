      ...
      <CardContent className="pt-5 flex flex-col gap-6">
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:items-center">
          ...
          <div className="flex items-center gap-4 lg:min-w-[220px]">
            ...
            <div className="flex-1">
              ...
              <p className="text-[10px] text-slate-800 font-medium mt-1">{currentXP.toLocaleString()} / {nextLevelXP.toLocaleString()} XP</p>
            </div>
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-2.5">
                  ...
                  <Badge className="bg-white text-slate-800 border-slate-200 text-[10px] font-bold">
                    Top 15% of teachers
                  </Badge>
                </div>
              </div>
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="lg:w-[280px] shrink-0">
            <h4 className="text-[11px] font-bold text-slate-700 uppercase tracking-widest mb-3">Earned Badges</h4>
            <div className="grid grid-cols-3 gap-2.5">
              <div className="flex flex-col items-center p-3 bg-indigo-50/70 border border-indigo-100 rounded-xl text-center hover:bg-indigo-100/70 transition-colors cursor-pointer group">
                <Medal className="w-6 h-6 text-indigo-700 mb-1 group-hover:scale-110 transition-transform" />
              ...
              <div className="flex flex-col items-center p-3 bg-red-50/70 border border-red-100 rounded-xl text-center hover:bg-red-100/70 transition-colors cursor-pointer group">
                <Target className="w-6 h-6 text-red-700 mb-1 group-hover:scale-110 transition-transform" />
          ...
          <div className="flex-1">
            <h4 className="text-[11px] font-bold text-slate-700 uppercase tracking-widest mb-3">Recent Commendations</h4>
            <div className="space-y-2.5">
              <div className="text-sm p-3 border border-slate-100 rounded-lg bg-white shadow-sm border-l-4 border-l-purple-500 hover:shadow-md transition-shadow">
                ...
                <p className="text-[10px] font-semibold text-slate-800 mt-1 uppercase tracking-wider">- Head of Dept (Maths)</p>
              </div>
              <div className="text-sm p-3 border border-slate-100 rounded-lg bg-white shadow-sm border-l-4 border-l-blue-500 hover:shadow-md transition-shadow">
                ...
                <p className="text-[10px] font-semibold text-slate-800 mt-1 uppercase tracking-wider">- Student Feedback</p>
              </div>
              <div className="text-sm p-3 border border-slate-100 rounded-lg bg-white shadow-sm border-l-4 border-l-emerald-500 hover:shadow-md transition-shadow">
                ...
                <p className="text-[10px] font-semibold text-slate-800 mt-1 uppercase tracking-wider">- Parent (Mrs. Doe)</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-slate-900 to-slate-800 rounded-xl p-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-800">Complete this to earn 150 bonus XP and unlock the Content King badge</p>
            </div>
          </div>
