...
export const PrimaryTeacherDashboard: React.FC = () => {
  const { user } = useAuth();
      ...
      try {
          ...
          intelligence: [
            {
              ...
              value: dashData.teachingIntelligence?.hardestTopic || 'P5 English Grammar',
              trendValue: 12,
            ...
            },
            {
              ...
              value: dashData.teachingIntelligence?.lowestEngagementClass || 'P4 Math',
              trendValue: 2,
            ...
            },
            {
              ...
              value: `${kpis.markingBacklog || 12} Exercises`,
              trendValue: 8,
              trendLabel: 'ungraded work',
              trendDirection: 'up',
              trendIsGood: false,
              riskLevel: 'warning',
        ...
        if (classesList.length > 0) {
           const mappedClasses = classesList.map((c: any) => ({
             id: String(c.id),
             name: c.title,
             level: c.subject?.class_level || 'Upper Primary',
           ...
           setClasses([
             { id: '1', name: 'Primary 6', level: 'Upper Primary', subject: 'Physics', enrolledStudents: 45, completionRate: 78, lastActive: '2 hours ago' },
             { id: '2', name: 'Primary 7', level: 'Upper Primary', subject: 'Mathematics', enrolledStudents: 32, completionRate: 85, lastActive: '1 day ago' },
           ]);
        }
  ...
  return (
    <div className="w-full min-h-screen bg-gray-100 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8 pb-6 border-b border-white/10">
          <div className="space-y-1.5">
            <div className="flex items-center gap-3">
               ...
               <Badge className="bg-blue-900/50 text-blue-200 hover:bg-blue-900/80 border-blue-500/30 backdrop-blur-sm">Uganda Primary Curriculum</Badge>
            </div>
          ...
          <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
             <Button variant="outline" className="hidden md:flex shadow-sm bg-white/5 backdrop-blur-md border-white/10 hover:bg-white/10 text-white" onClick={() => navigate('/live-sessions')}><Calendar className="w-4 h-4 mr-2 text-slate-300" /> My Calendar</Button>
             <Button variant="outline" className="hidden lg:flex shadow-sm bg-amber-500/10 backdrop-blur-md border-amber-300/50 hover:bg-amber-500/20 text-amber-200" onClick={() => navigate('/primary/p7-readiness')}><GraduationCap className="w-4 h-4 mr-2 text-amber-200" /> P7 PLE Dashboard</Button>
           ...
           <DashboardGrid className="!items-stretch">
             ...
             <DashboardCard colSpan={1} mdColSpan={6} lgColSpan={5} variant="glass">
               <ResourceEffectivenessIntelligence 
                 subjectContext="Primary 6 Mathematics"
                 resources={[
        ...
        {/* Phase 8 Resource Engagement Tracking & Marking */}
        ...
        <div className="flex flex-wrap gap-6 mb-8 mt-8">
           ...
           <div className="w-full lg:flex-[1] flex flex-col">
              <HouseStandingsCard 
                institutionName="Kampala Primary"
                houses={[
          ...
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <div className="p-2 bg-purple-100 rounded-lg">
                <Brain className="h-6 w-6 text-purple-800" />
              </div>
              AI Teaching Assistant
            </CardTitle>
            <p className="text-gray-800">Leverage AI to enhance your teaching effectiveness and student engagement</p>
          </CardHeader>
          <CardContent>
                ...
                <div className="bg-white rounded-lg p-4 border border-purple-200 hover:shadow-md transition-all group-hover:border-purple-300 h-full flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-800">Student analytics</p>
                    </div>
                  </div>
                  <p className="text-xs text-gray-700 mb-3 flex-1">Identify topics where students struggle most</p>
                ...
                <div className="bg-white rounded-lg p-4 border border-blue-200 hover:shadow-md transition-all group-hover:border-blue-300 h-full flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-800">AI assistance</p>
                    </div>
                  </div>
                  <p className="text-xs text-gray-700 mb-3 flex-1">Generate helpful responses to student questions</p>
                ...
                <div className="bg-white rounded-lg p-4 border border-green-200 hover:shadow-md transition-all group-hover:border-green-300 h-full flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-800">Auto-create tests</p>
                    </div>
                  </div>
                  <p className="text-xs text-gray-700 mb-3 flex-1">Create quizzes from your lesson content automatically</p>
                ...
                <div className="bg-white rounded-lg p-4 border border-indigo-200 hover:shadow-md transition-all group-hover:border-indigo-300 h-full flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-800">Performance insights</p>
                    </div>
                  </div>
                  <p className="text-xs text-gray-700 mb-3 flex-1">Track content effectiveness and student engagement</p>
        ...
        <Tabs defaultValue="overview" className="space-y-6">
          ...
          <TabsContent value="overview" className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex flex-wrap gap-6 items-stretch mb-6">
              ...
              <div className="w-full lg:flex-[2] flex flex-col space-y-6">
                 ...
                 <TeachingWinsTimeline wins={[
                    { id: 'w1', timestamp: 'Today, 10:00 AM', title: 'P6 Science recovered', description: 'Class average jumped by 12% after your recent intervention block.', impactType: 'score_jump' },
            ...
            <div className="bg-white/5 backdrop-blur-xl rounded-[1.8rem] p-6 shadow-2xl border border-white/20 relative overflow-hidden">
               ...
               <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                 ...
                 <ClassHealthCard 
                    id="c2"
                    className="Primary 6 Mathematics"
                    subject="Mathematics"
                    attendancePct={78}
                    avgPerformance={48}
                    redAlertStudents={5}
          ...
          <TabsContent value="classes" className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <Card>
              <CardHeader>
                ...
                <p className="text-gray-800">Manage your teaching assignments across different Uganda classes</p>
              </CardHeader>
              <CardContent>
                    ...
                    <Card key={classItem.id} className="hover:shadow-md transition-shadow w-full lg:w-[calc(33.333%-1rem)] flex flex-col justify-between">
                      <CardHeader>
                        <div className="flex justify-between items-start">
                          ...
                          <span className="text-sm text-gray-700">{classItem.enrolledStudents} students</span>
                        </div>
                        <CardTitle className="text-lg">{classItem.name}</CardTitle>
                        <p className="text-gray-800">{classItem.subject}</p>
                      </CardHeader>
                      <CardContent>
                        <div className="space-y-3">
                          <div>
                            <div className="flex justify-between mb-1">
                              <span className="text-sm text-gray-800">Avg Completion</span>
                          ...
                          <div className="flex gap-2">
                            <Button size="sm" variant="outline" className="flex-1" onClick={() => navigate(`/dashboard/teacher/class/${classItem.id}`)}>
                              View Details
                            </Button>
                            <Button size="sm" className="flex-1" onClick={() => navigate(`/dashboard/teacher/class/${classItem.id}`)}>
                              Manage
                            </Button>
                          </div>
                        </div>
            ...
            <div className="space-y-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <p className="text-gray-800">Add videos, notes, or exercises to the academic marketplace or your internal library</p>
                </CardHeader>
                <CardContent>
                  <div className="flex flex-wrap gap-4">
                    <Button variant="outline" className="h-24 flex-[1_1_200px] flex flex-col border-indigo-200 hover:bg-indigo-50" onClick={() => setIsLibraryUploadOpen(true)}>
                      <Upload className="h-8 w-8 mb-2 text-indigo-700" />
                      Upload to Library
                    </Button>
                    <Button variant="outline" className="h-24 flex-[1_1_200px] flex flex-col" onClick={() => setIsUploadModalOpen(true)}>
                      <Video className="h-8 w-8 mb-2 text-red-700" />
                      Marketplace Video
                    </Button>
                    <Button variant="outline" className="h-24 flex-[1_1_200px] flex flex-col" onClick={() => setIsUploadModalOpen(true)}>
                      <FileText className="h-8 w-8 mb-2 text-blue-700" />
                      Marketplace Notes
                    </Button>
                    <Button variant="outline" className="h-24 flex-[1_1_200px] flex flex-col" onClick={() => setIsUploadModalOpen(true)}>
                      <BookOpen className="h-8 w-8 mb-2 text-emerald-700" />
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={index} className="flex items-center justify-between border rounded-lg p-4">
                        <div className="flex items-center gap-3">
                          {item.type === 'Video' && <Video className="h-5 w-5 text-red-700" />}
                          {item.type === 'Exercise' && <BookOpen className="h-5 w-5 text-emerald-700" />}
                          {item.type === 'Document' && <FileText className="h-5 w-5 text-blue-700" />}
                          <div>
                            <h4 className="font-medium text-gray-900">{item.title}</h4>
                            <p className="text-sm text-gray-800">{item.type} • {item.views} views</p>
                          </div>
                        </div>
                        <div className="flex items-center gap-3">
                          ...
                          <Button variant="outline" size="sm" onClick={() => toast.info('Opening resource editor...')}>Edit</Button>
                        </div>
                      </div>
                    ))}
                  </div>
                 ...
                 <div className="bg-white rounded-[2rem] p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
                   <div className="space-y-5">
                      ...
                      <div>
                        ...
                        <input 
                          type="text" 
                          placeholder="e.g., Primary 5 Mathematics - Quadratic Equations"
                          className="w-full bg-slate-50 border-0 rounded-2xl px-4 py-3.5 text-slate-700 font-medium focus:ring-2 focus:ring-primary/20 outline-none transition-all placeholder:text-slate-800" 
                        />
                      </div>
          ...
          <TabsContent value="upload-center" className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <ContentManagementPanel role="teacher" />
          </TabsContent>
        </Tabs>
      </div>
